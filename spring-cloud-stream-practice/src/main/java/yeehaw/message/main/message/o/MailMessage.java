...
public class MailMessage extends BaseMessage {
	...
	public MailMessage() {
		...
		setCategory(Category.MAIL.getValue());
	 ...
	 *            是否静默信息
	 */
	public MailMessage(String sourceMsgId, String source, String target, String title, boolean silent) {
	 ...
	 *            是否静默信息
	 */
	public MailMessage(String sourceMsgId, String source, String target, String title, String content, boolean silent) {
	 ...
	 *            是否静默信息
	 */
	public MailMessage(String sourceMsgId, String source, String[] targets, String title, String content,
