...
public class TaskMessage extends BaseMessage {
	...
	public TaskMessage(){
		...
		setCategory(Category.TASK.getValue());
	 ...
	 *            是否静默信息
	 */
	public TaskMessage(String sourceMsgId, String source, String target, String title, boolean silent) {
	 ...
	 *            是否静默信息
	 */
	public TaskMessage(String sourceMsgId, String source, String target, String title, String content, boolean silent) {
	 ...
	 *            是否静默信息
	 */
	public TaskMessage(String sourceMsgId, String source, String[] targets, String title, String content,
